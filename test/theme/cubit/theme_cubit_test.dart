...
import 'package:the_hermitage_community/src/features/tutorials/weather/theme/cubit/theme_cubit.dart';
    ...
    () {
      ...
      group(
        ...
        () {
          ...
          blocTest<ThemeCubit, Color>(
            'emits default color for WeatherCondition.unknown',
            build: ThemeCubit.new,
